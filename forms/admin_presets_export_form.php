...
class admin_presets_export_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'general',
                get_string('presetsettings', 'block_admin_presets2'));
        ...
        $mform->addElement('text', 'author',
                get_string('author', 'block_admin_presets2'), 'maxlength="254" size="60"');
        $mform->setType('author', PARAM_TEXT);
        $mform->setDefault('author', $USER->firstname . ' ' . $USER->lastname);

        $mform->addElement('checkbox', 'excludesensiblesettings',
                get_string('autohidesensiblesettings', 'block_admin_presets2'));

        // Moodle settings table.
        $mform->addElement('header', 'general',
                get_string('adminsettings', 'block_admin_presets2'));
