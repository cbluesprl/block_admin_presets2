...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtextarea('block_admin_presets2/sensiblesettings',
            get_string('sensiblesettings', 'block_admin_presets2'),
            get_string('sensiblesettingstext', 'block_admin_presets2'),
    ...
    $settings->add(new admin_setting_configcheckbox(
        'block_admin_presets2/automaticexport',
        get_string('automaticexportconfig', 'block_admin_presets2'),
        get_string('automaticexportconfig', 'block_admin_presets2'),
        $automaticexportdefault, true, false));

    $settings->add(new admin_setting_configcheckbox(
        'block_admin_presets2/automaticexportcleanup',
        get_string('automaticexportcleanupconfig', 'block_admin_presets2'),
        get_string('automaticexportcleanupconfigtext', 'block_admin_presets2'),
