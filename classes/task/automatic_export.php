...
namespace block_admin_presets2\task;
...
class automatic_export extends scheduled_task {
    ...
    public function get_name() {
        return get_string('automaticexport', 'block_admin_presets2');
    }
    ...
    public function execute() {
        ...
        $config = get_config('block_admin_presets2', 'automaticexport');
        if (empty($config)) {
            return;
        }

        require_once $CFG->dirroot . "/blocks/admin_presets2/lib/admin_presets_export.class.php";
        ...
        if (empty($settingsfound)) {
            ...
            redirect($CFG->wwwroot . '/blocks/admin_presets2/index.php?action=export',
                get_string('novalidsettingsselected', 'block_admin_presets2'), 4);
        }
