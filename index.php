...
$formpath = $CFG->dirroot . '/blocks/admin_presets2/forms/' . $formname . '.php';
require_once($CFG->dirroot . '/blocks/admin_presets2/lib/' . $classname . '.class.php');
if (file_exists($formpath)) {
    require_once($formpath);
}

if (!class_exists($classname)) {
    print_error('falseaction', 'block_admin_presets2', $action);
}

$url = new moodle_url('/blocks/admin_presets2/index.php');
...
if (!method_exists($instance, $mode)) {
    print_error('falsemode', 'block_admin_presets2', $mode);
}
