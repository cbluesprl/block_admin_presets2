 ...
 */
function xmldb_block_admin_presets2_upgrade($oldversion, $block) {
    global $DB;
    ...
    if ($oldversion < 2011063000) {
        ...
        upgrade_block_savepoint(true, 2011063000, 'admin_presets2');
    }
    ...
    if ($oldversion < 2012031401) {
        ...
        try {
            ...
            $debuginfo = get_string('errorupgradetablenamesdebug', 'block_admin_presets2');
            throw new moodle_exception('errorupgradetablenames', 'block_admin_presets2', '', null, $debuginfo);
        }

        upgrade_block_savepoint(true, 2012031401, 'admin_presets2');
    }
    return true;
}
